...
### 概览
RiseUp 是一款集成AI技术的个人生产力和幸福感提升工具，用户在配置基础信息之后，例如个人作息，长期目标，基础信息等等，每天晚上记录当天觉得值得记录的事件，并且安排好第二天的To-do List，第二天早上会收到一封包含感恩提醒，长期目标提醒，天气信息，时间管理建议，今日任务列表的邮件，并且可以选择更新到Notion中。
