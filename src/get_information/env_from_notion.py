...
def get_user_env_vars():
    ...
    for page in response.get("results", []):
        ...
        user_env_vars[user_id] = {
            ...
            "ABOUT_ME": page['properties']['ABOUT_ME']['rich_text'][0]['text']['content'],
            "PRESENT_LOCATION": page['properties']['PRESENT_LOCATION']['rich_text'][0]['text']['content'],
            "DAILY_ROUTINE": page['properties']['DAILY_ROUTINE']['rich_text'][0]['text']['content'],
            "LONG_TERM_GOAL": page['properties']['LONG_TERM_GOAL']['rich_text'][0]['text']['content'],
            # hyper parameter
            ...
            "DISPLAY_PAGE_ID": page['properties']['DISPLAY_PAGE_ID']['rich_text'][0]['text']['content'],
            "DISPLAY_WAY": page['properties']['DISPLAY_WAY']['rich_text'][0]['text']['content']
        }
